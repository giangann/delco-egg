...
const create = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userData = yield typeorm_1.getRepository(user_entity_1.User).save(Object.assign(Object.assign({}, params), item));
...
const login = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield typeorm_1.getRepository(user_entity_1.User)
        ...
        .getOne();
    if (!user) {
        throw new string_error_1.StringError('Your username has not been registered');
    }
...
const update = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield typeorm_1.getRepository(user_entity_1.User).update(query, Object.assign(Object.assign({}, params), { updatedAt: date_time_utility_1.default.getCurrentTimeStamp() }));
});
