...
class ApiResponse {
    static result = (res, data, status = 200, cookie = null, pagination = null) => {
        res.status(status);
        if (cookie) {
    ...
    static error = (res, status = 400, error = http_status_codes_1.default.getStatusText(status), override = null) => {
